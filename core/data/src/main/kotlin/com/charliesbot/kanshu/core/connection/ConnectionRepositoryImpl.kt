...
class ConnectionRepositoryImpl(private val api: KavitaApi) : ConnectionRepository {
  override suspend fun testConnection(baseUrl: String, apiKey: String): ConnectionTestResult {
